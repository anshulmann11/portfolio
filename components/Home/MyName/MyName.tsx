  ...
  return (
    ...
    >
      ...
      >
        ...
        digital experiences. My current area of focus is in the <span className="text-AAsecondary">Node js</span>,
        where I actively engage in developing <br className="2xl:block hidden"/>
        and designing immersive <span className="text-AAsecondary">Backend Applications</span>. This involves working with databases such as {" "}
        <span className="text-AAsecondary">MongoDB</span>  and {" "}
        <span className="text-AAsecondary"> Postgres </span>. 
